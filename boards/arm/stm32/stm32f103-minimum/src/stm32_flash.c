/****************************************************************************
 * boards/arm/stm32/stm32f103-minimum/src/stm32_flash.c
 *
...
#ifndef CONFIG_STM32_FLASH_BL_PROG_SIZE
#define CONFIG_STM32_FLASH_BL_PROG_SIZE 0
#endif

#ifndef CONFIG_STM32_FLASH_CPU1_PROG_SIZE
#define CONFIG_STM32_FLASH_CPU1_PROG_SIZE 0
#endif

#ifndef CONFIG_STM32_FLASH_CPU2_PROG_SIZE
#define CONFIG_STM32_FLASH_CPU2_PROG_SIZE 0
#endif

#ifndef CONFIG_STM32_FLASH_PART1_SIZE
#define CONFIG_STM32_FLASH_PART1_SIZE 0
#endif

#ifndef CONFIG_STM32_FLASH_PART2_SIZE
#define CONFIG_STM32_FLASH_PART2_SIZE 0
#endif

#ifndef CONFIG_STM32_FLASH_PART3_SIZE
#define CONFIG_STM32_FLASH_PART3_SIZE 0
#endif

#ifndef CONFIG_STM32_FLASH_PART4_SIZE
#define CONFIG_STM32_FLASH_PART4_SIZE 0
#endif

#if (CONFIG_STM32_FLASH_BL_PROG_SIZE + \
     CONFIG_STM32_FLASH_CPU1_PROG_SIZE + \
     CONFIG_STM32_FLASH_CPU2_PROG_SIZE + \
     CONFIG_STM32_FLASH_PART1_SIZE + \
     CONFIG_STM32_FLASH_PART2_SIZE + \
     CONFIG_STM32_FLASH_PART3_SIZE + \
     CONFIG_STM32_FLASH_PART4_SIZE) > 128
...
{
#if CONFIG_STM32_FLASH_BL_PROG_SIZE > 0
  {
    .size   = CONFIG_STM32_FLASH_BL_PROG_SIZE,
    .name   = "bl-progmem",
    .mnt    = NULL,
    .fs     = "rawfs"
  },
  ...
  {
    .size   = CONFIG_STM32_FLASH_CPU1_PROG_SIZE,
    .name   = "cpu1-progmem",
    .mnt    = NULL,
    .fs     = "rawfs"
  },

#if CONFIG_STM32_FLASH_CPU2_PROG_SIZE > 0
  {
    .size   = CONFIG_STM32_FLASH_CPU2_PROG_SIZE,
    .name   = "cpu2-progmem",
    .mnt    = NULL,
    .fs     = "rawfs"
  },
  ...
  {
    .size   = CONFIG_STM32_FLASH_PART1_SIZE,
    .name   = CONFIG_STM32_FLASH_PART1_NAME,
    .mnt    = CONFIG_STM32_FLASH_PART1_MNT,
    .fs     = CONFIG_STM32_FLASH_PART1_FS
  },

#if CONFIG_STM32_FLASH_PART2_SIZE > 0
  {
    .size   = CONFIG_STM32_FLASH_PART2_SIZE,
    .name   = CONFIG_STM32_FLASH_PART2_NAME,
    .mnt    = CONFIG_STM32_FLASH_PART2_MNT,
    .fs     = CONFIG_STM32_FLASH_PART2_FS
  },
#endif /* CONFIG_STM32_FLASH_PART2_SIZE */

#if CONFIG_STM32_FLASH_PART3_SIZE > 0
  {
    .size   = CONFIG_STM32_FLASH_PART3_SIZE,
    .name   = CONFIG_STM32_FLASH_PART3_NAME,
    .mnt    = CONFIG_STM32_FLASH_PART3_MNT,
    .fs     = CONFIG_STM32_FLASH_PART3_FS
  },
#endif /* CONFIG_STM32_FLASH_PART3_SIZE */

#if CONFIG_STM32_FLASH_PART4_SIZE > 0
  {
    .size   = CONFIG_STM32_FLASH_PART4_SIZE,
    .name   = CONFIG_STM32_FLASH_PART4_NAME,
    .mnt    = CONFIG_STM32_FLASH_PART4_MNT,
    .fs     = CONFIG_STM32_FLASH_PART4_FS
  },
#endif /* CONFIG_STM32_FLASH_PART4_SIZE */
};
  ...
  for (i = 0; i != sizeof(part_table) / sizeof(struct part_table); i++)
    {
      ...
      printf("[%s] creating partition, size: %d, fs: %s, offset: %d\n",
            name, size, fs, offset);
      ...
      if (mtd_part == NULL)
        {
          printf("[%s]ERROR: mtd_partition() failed %d\n", name, errno);
          continue;
        }

      if (mtd_setpartitionname(mtd_part, name))
        {
          printf("[%s]ERROR: mtd_setpartitionname() failed %d\n", name, errno);
          continue;
        }
      ...
      if (strcmp(fs, "rawfs") == 0)
        {
          ...
          if ((ret = ftl_initialize(mtdblk_minor, mtd_part)))
            {
              printf("[%s]ERROR: ftl_initialize failed %d\n", name, ret);
              continue;
            }
